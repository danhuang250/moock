  ...
  <div class="edu-container">
    ...
    <div class="list-top">
      ...
      <div class="list-tab">
        ...
        <dl>
          <dd :class="{ on: subjectParentId == 0 }">
            <a href="" @click.prevent="toSubjectList(0)">全部</a>
          </dd>
          <dd :class="{ on: item.id == subjectParentId }" v-for="item in subject">
            <a href="" @click.prevent="toSubjectList(item.id, 0)">{{ item.name }}</a>
          </dd>
        </dl>
      </div>
      ...
      <div class="list-tab">
        ...
        <dl>
          <el-scrollbar max-height="100px">
            <dd :class="{ on: sonSubjectId == 0 }">
              <a href="" @click.prevent="toSubjectList(0, null)">全部</a>
            </dd>
            <dd :class="{ on: item.id == sonSubjectId }" v-for="item in sonSubject">
              <a href="" @click.prevent="toSubjectList(item.parentId, item.id)">{{ item.name }}</a>
            </dd>
          </el-scrollbar>
        </dl>
      </div>
      ...
      <div class="list-tab">
        ...
        <dl>
          <dd :class="{ on: difficulty == 'all' }">
            <a href="" @click.prevent="toDiffList('all')">全部</a>
          </dd>
          <dd :class="{ on: difficulty == 0 }">
            <a href="" @click.prevent="toDiffList(0)">入门</a>
          </dd>
          <dd :class="{ on: difficulty == 1 }">
            <a href="" @click.prevent="toDiffList(1)">初级</a>
          </dd>
          <dd :class="{ on: difficulty == 2 }">
            <a href="" @click.prevent="toDiffList(2)">中级</a>
          </dd>
          <dd :class="{ on: difficulty == 3 }">
            <a href="" @click.prevent="toDiffList(3)">高级</a>
          </dd>
        </dl>
      </div>
      <!--难度 end-->
      ...
      <div class="list-tab">
        ...
        <dl>
          <dd :class="{ on: courseType == 'all' }">
            <a href="" @click.prevent="toTypeList('all')">全部</a>
          </dd>
          <dd :class="{ on: courseType == 0 }">
            <a href="" @click.prevent="toTypeList(0)">新手入门</a>
          </dd>
          <dd :class="{ on: courseType == 1 }">
            <a href="" @click.prevent="toTypeList(1)">新上好课</a>
          </dd>
          <dd :class="{ on: courseType == 2 }">
            <a href="" @click.prevent="toTypeList(2)">技能提高</a>
          </dd>
          <dd :class="{ on: courseType == 3 }">
            <a href="" @click.prevent="toTypeList(3)">理论知识</a>
          </dd>
        </dl>
      </div>
      <!--类型 end-->
